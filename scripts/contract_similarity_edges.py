...
def main():
    ...
    ap.add_argument("--membership", required=True, help="tree_node_membership_L{n}.csv")
    ap.add_argument("--pairs", required=True, help="data/intermediate_outputs/policy_similarity_rerank_edges.csv")
    ap.add_argument("--out", required=True, help="cluster_similarity_edges_L{n}.csv")
    args = ap.parse_args()
