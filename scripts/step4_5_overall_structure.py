...
# -*- coding: utf-8 -*-
"""
Step 4.5 · Overall Structure (Fixed Version)
...
# --- 4. 默认输出/输入路径 ---
DEFAULT_L1_DEF = PROJECT_ROOT / "data" / "intermediate_outputs" / "v4_l1_definition.json"
DEFAULT_OPS_OUT = PROJECT_ROOT / "data" / "intermediate_outputs" / "v4_final_ops.jsonl"
DEFAULT_AUDIT = PROJECT_ROOT / "data" / "intermediate_outputs" / "v4_final_audit.json"
DEFAULT_FLAT = PROJECT_ROOT / "data" / "intermediate_outputs" / "v4_tree_final_flat.csv"
...
def main():
    parser = argparse.ArgumentParser(description="Round C v4 · Step4.5 Overall Structure (Fixed)")
