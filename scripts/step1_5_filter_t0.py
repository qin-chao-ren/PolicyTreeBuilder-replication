...
"""
Step 1.5 · T0 过滤（roundC v4）

- 输入（默认）: data/intermediate_outputs/v4_cluster_corpus_cleaned.csv
  必需列: sample_id, cleaned_title, final_level, doc_id
- 输出（默认）: data/intermediate_outputs/v4_corpus_filtered.csv
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Round C v4 · Step 1.5 T0 Filter")
    ...
    out_path = out_dir / "v4_corpus_filtered.csv"
