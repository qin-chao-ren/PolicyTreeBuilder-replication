...
if __name__ == "__main__":
    # 配置你的路径
    # 注意：请确保这些路径指向你真实的文件
    T5_FILE = "data/intermediate_outputs/policy_action_units_ruled.csv"
    SOURCE_FILE = "data/source/policy_action_segments.csv"
    OUTPUT_FILE = "data/intermediate_outputs/policy_audit_sample.json"
